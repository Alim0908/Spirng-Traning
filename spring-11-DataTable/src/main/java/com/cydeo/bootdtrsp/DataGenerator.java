...
@Component// becouse this class is a dependency
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Car c3 = new Car("Audi", "x6");

        // i want to save c1,c2,c3 to the db
        //and do we have any method to do this job? yes in the carRepository Calss i have ,
